...
interface LaneRoadMarkIdentifierInterface {
...
data class LaneRoadMarkIdentifier(override val laneRoadMarkIndex: Int, val laneIdentifier: LaneIdentifier) :
    ...
    // Conversions
    override fun toStringMap() = mapOf("laneRoadMarkIndex" to laneRoadMarkIndex.toString()) + laneIdentifier.toStringMap()
}

interface AdditionalLaneRoadMarkIdentifier {
    var additionalId: Option<LaneRoadMarkIdentifier>
}
