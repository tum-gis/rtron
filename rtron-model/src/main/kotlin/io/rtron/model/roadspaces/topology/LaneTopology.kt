 ...
 */
data class IdentifiableFillerSurface(
    val laneId: LaneIdentifier,
    val successorLaneId: LaneIdentifier,
...
class LaneTopology(
    ...
    private fun getSuccessorLanesBetweenRoads(laneId: LaneIdentifier):
        Result<List<LaneIdentifier>, IllegalArgumentException> {
            ...
            val road = roadspaces.getValueResult(laneId.toRoadspaceIdentifier())
                .handleFailure { throw it.error }.road
            check(road.linkage.successorRoadspaceId.isPresent()) { "Current road must have a successor road." }
    ...
    private fun getSuccessorLanesBetweenRoadsInJunction(laneId: LaneIdentifier):
        Result<List<LaneIdentifier>, IllegalArgumentException> {
            ...
            check(road.linkage.successorJunctionId.isPresent()) { "Current road must have a successor junction." }
