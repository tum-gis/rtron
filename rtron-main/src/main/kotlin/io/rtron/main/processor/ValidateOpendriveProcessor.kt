 ...
 */
 ...
 class ValidateOpendriveProcessor(
     ...
     companion object {
         ...
         val currentDirectory: Path = Paths.get(".")
         val OPENDRIVE_SCHEMA_VALIDATOR_REPORT_PATH = currentDirectory.resolve("..").resolve("01_opendrive_schema_validator_report.json")
         val OPENDRIVE_EVALUATOR_REPORT_PATH = currentDirectory.resolve("..").resolve("02_opendrive_evaluator_report.json")
