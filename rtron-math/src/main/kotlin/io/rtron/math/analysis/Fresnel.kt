    ...
    fun calculatePoint(l: Double): Pair<Double, Double> {
        ...
        when {
            ...
            x > 36974.0 -> {
                ...
                val u = 1.0 / (t * t)
                t = 1.0 / t
                val f = 1.0 - u * PolynomialFunction(fn).valueOrNull(u)!! / PolynomialFunction(fd).valueOrNull(u)!!
                val g = t * PolynomialFunction(gn).valueOrNull(u)!! / PolynomialFunction(gd).valueOrNull(u)!!
