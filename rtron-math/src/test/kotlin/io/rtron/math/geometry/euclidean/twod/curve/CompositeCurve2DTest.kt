...
internal class CompositeCurve2DTest {
    ...
    inner class TestPoseCalculation {
        ...
        fun `calculating last point on curve is not NaN`() {
            ...
            val curveMember1 = LineSegment2D(4.8660000002386461e-01, affineSequence1, tolerance = tolerance)
            ...
            val curveMember2 = SpiralSegment2D(
                    ...
                    affineSequence2, tolerance = tolerance)
            ...
            val curveMember3 = Arc2D(-1.2698412698412698e-01, 9.1954178989066371e+00,
                    affineSequence3, tolerance = tolerance)
            ...
            val curveMember4 = SpiralSegment2D(
                    LinearFunction.ofSpiralCurvature(-1.2698412698412698e-01,
                            ...
                            3.1746031746031744e+00),
                    affineSequence4, tolerance = tolerance)
