...
package io.rtron.transformer.evaluator.opendrive.plans.basicdatatype.junction
...
class JunctionEvaluator(val configuration: OpendriveEvaluatorConfiguration) {
    ...
    private fun evaluateNonFatalViolations(junction: Junction): ContextReport<Junction> {
        ...
        report += healedJunction.healMinorViolations().toReport(junction, isFatal = false, wasHealed = true)
