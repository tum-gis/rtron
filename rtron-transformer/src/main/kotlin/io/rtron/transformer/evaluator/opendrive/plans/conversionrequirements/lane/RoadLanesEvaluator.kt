...
package io.rtron.transformer.evaluator.opendrive.plans.conversionrequirements.lane
...
class RoadLanesEvaluator(val configuration: OpendriveEvaluatorConfiguration) {
    ...
    // Methods
    fun evaluateFatalViolations(road: Road): Report {
        val report = Report()
    ...
    fun evaluateNonFatalViolations(road: Road): ContextReport<RoadLanes> {
        val healedRoadLanes = road.lanes.copy()
        val report = Report()
