...
object Surface3DBuilder {
    ...
    fun buildLinearRingsByRoadCorners(
        ...
        numberTolerance: Double,
    ): ContextIssueList<List<LinearRing3D>> {
     ...
     */
    private fun buildLinearRingByRoadCorners(
     ...
     */
    private fun buildLinearRingByLocalCorners(
        outline: RoadObjectsObjectOutlinesOutline,
        numberTolerance: Double,
    ): Either<GeometryBuilderException, ContextIssueList<LinearRing3D>> {
        val outlineId =
    ...
    fun buildParametricBoundedSurfacesByHorizontalRepeat(
        ...
        val parametricBoundedSurface =
            ParametricBoundedSurface3D(leftBoundary, rightBoundary, numberTolerance, ParametricBoundedSurface3D.DEFAULT_STEP_SIZE)
    ...
    fun buildParametricBoundedSurfacesByVerticalRepeat(
        ...
        val parametricBoundedSurface =
            ParametricBoundedSurface3D(lowerBoundary, upperBoundary, numberTolerance, ParametricBoundedSurface3D.DEFAULT_STEP_SIZE)
        return listOf(parametricBoundedSurface)
    }
}
