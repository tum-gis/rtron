...
fun AbstractThematicSurface.populateLod2MultiSurfaceOrLod0Geometry(
    geometryTransformer: GeometryTransformer,
): Either<GeometryTransformerException, Unit> {
    ...
    return GeometryTransformerException
        .NoSuiteableSourceGeometry(
            "LOD2 multi surface or LOD0 geometry of the abstract thematic surface.",
        ).left()
}
...
fun AbstractThematicSurface.populateLod0Geometry(geometryTransformer: GeometryTransformer): Either<GeometryTransformerException, Unit> =
    either {
        ...
        GeometryTransformerException
            .NoSuiteableSourceGeometry("LOD0 geometry of the abstract thematic surface.")
            .left()
            .bind()
    }
...
fun AbstractThematicSurface.populateLod1MultiSurface(geometryTransformer: GeometryTransformer): Either<GeometryTransformerException, Unit> =
    either {
        ...
        GeometryTransformerException
            .NoSuiteableSourceGeometry("LOD1 multi surface of the abstract thematic surface.")
            .left()
            .bind()
    }
 ...
 * @return [Either.Right] is returned, if a geometry has been populated; [Either.Left], if no adequate geometry could be assigned
 */
fun AbstractThematicSurface.populateLod2MultiSurface(geometryTransformer: GeometryTransformer): Either<GeometryTransformerException, Unit> =
    either {
        geometryTransformer.getMultiSurface().onSome { currentMultiSurfaceResult ->
        ...
        GeometryTransformerException
            .NoSuiteableSourceGeometry("LOD2 multi surface of the abstract thematic surface.")
            .left()
            .bind()
    }
...
fun AbstractThematicSurface.populateLod3MultiSurface(geometryTransformer: GeometryTransformer): Either<GeometryTransformerException, Unit> =
    either {
        ...
        GeometryTransformerException
            .NoSuiteableSourceGeometry("LOD3 multi surface of the abstract thematic surface.")
            .left()
            .bind()
    }

fun AbstractThematicSurface.populateLod2MultiSurfaceFromSolidCutoutOrSurface(
    geometryTransformer: GeometryTransformer,
    solidFaceSelection: List<GeometryTransformer.FaceType>,
): Either<GeometryTransformerException, Unit> =
    either {
        geometryTransformer
            .getSolidCutoutOrSurface(*solidFaceSelection.toTypedArray())
