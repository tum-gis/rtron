...
object LinearRing3DFactory {
    ...
    fun buildFromVertices(
        ...
        either {
            ...
            val preparedVertices =
                verticesWithoutSideDuplicates
            ...
            val orderedVertices =
                if (projectedVertices.distinct().size > 2 && projectedVertices.isClockwiseOrdered()) {
                    issueList +=
                        DefaultIssue.of(
