...
class BuildingModuleBuilder(
    ...
    private fun createLod2Building(id: RoadspaceObjectIdentifier, geometryTransformer: GeometryTransformer): Either<Exception, Building> {
        ...
        identifierAdder.addDetailedIdentifier(id, id.roadspaceObjectName.getOrElse { "" }, "RoofSurface", dstCityObject = roofSurfaceFeature) // TODO fix option
        ...
        identifierAdder.addDetailedIdentifier(id, id.roadspaceObjectName.getOrElse { "" }, "FloorSurface", dstCityObject = groundSurfaceFeature) // TODO fix option
        ...
        geometryTransformer.getIndividualSolidCutouts(GeometryTransformer.FaceType.SIDE)
            ...
            .forEachIndexed { index, multiSurfaceProperty ->
                ...
                identifierAdder.addDetailedIdentifier(id, id.roadspaceObjectName.getOrElse { "" }, "WallSurface", index, wallSurfaceFeature) // TODO fix option
            }
